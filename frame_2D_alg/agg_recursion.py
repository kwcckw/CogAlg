...
def agg_recursion(levels, level, fseg, fiPd):  # compositional recursion per blob.Plevel.
    ...
    PP_ = levels[fiPd][-2]   # blob is actually PP, recursion forms segP_t, seg_PP_t, etc.
    '''
