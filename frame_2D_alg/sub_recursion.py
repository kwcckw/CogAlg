...
from comp_slice import sum_vertuple, sum_derH, sum_tuple, comp_P, comp_ptuple, comp_vertuple, comp_angle, form_PP_t
        ...
        for P in iP_:
            ...
            for iderP in P.link_t[0]:  # mlinks
                ...
                for _derP in _P.link_t[0]:  # next layer of mlinks
                    ...
                    comp_P(P,__P, Mtuple, Dtuple, links, Valt, Rdnt, fd=0, valt=None)
                    # comp_P through 73? Yes, i think this should be the same.
                    """
                    ...
                    """
            if Valt[0] > ave_P * Rdnt[0]:  # form new Ps in rng+ PP:
...
# i think we need another comp_P_der, instead of packing it in comp_P, because it becomes very messy later
    ...
    for iP_ in reversed(iP__[:-1]):  # lower compared row, follow uplinks, no uplinks in last row
        ...
        for P in iP_:
            ...
            for iderP in P.link_t[1]:  # dlinks
                ...
                # if we always compare vertuple[1], mtuple is always empty here
