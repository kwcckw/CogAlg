...
class CP(ClusterStructure):  # horizontal blob slice P, with vertical derivatives per param if derP, always positive
    ...
    derT = lambda: [[],[]]  # mH,dH pair, 1vertuple / 1layer in comp_slice, extend in der+
    valT = lambda: [[[0]],[[0]]]
    rdnT = lambda: [[[1]],[[1]]]
...
class CPP(CderP):
    ...
    derT = lambda: [[],[]]  # mH,dH pair, 1vert'1lay in comp_slice, extend in sub+, no comp rngH till agg+
