...
for i, blob in enumerate(frame['blob__']):
    ...
    try:
        ...
        if blob['adj_blob_'] and False in blob['dert__'][0].mask:
            ...
            # draw bounding box
            cv2.rectangle(img_blob_, (blob['box'][2], blob['box'][0]), \
            ...
            for j, adj_blob in enumerate(blob['adj_blob_']):
                ...
                if False in adj_blob['dert__'][0].mask:
                    ...
                    # draw bounding box
                    cv2.rectangle(img_blob_, (adj_blob['box'][2], adj_blob['box'][0]), \
            ...
            cv2.imwrite("images/adj_blob_mask/mask_adj_blob"+str(i)+".png", img_blob_.astype('uint8'))
